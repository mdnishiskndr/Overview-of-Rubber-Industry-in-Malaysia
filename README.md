This project is created to fulfill the requirement of a mini project task to challenge interns in creating data visualizations using Tableau and Alteryx software.
